...
# ============================================================
# 1. CARREGAR RR REAL E CALCULAR RMSSD REAL (JANELA DESLIZANTE)
# ============================================================
rr = np.loadtxt('/home/claude/active_inference_workspace/fantasia_Y1_RR_intervals.txt')  # segundos
...
def sliding_rmssd(rr_series, window=60, step=30):
    """RMSSD real = sqrt(media((RR[i+1]-RR[i])^2)) em janela deslizante de batimentos."""
...
# interpolar para T=400 pontos (para alinhar com a simulação)
...
plt.tight_layout()
plt.savefig('/home/claude/active_inference_workspace/real_hrv_experiment.png', dpi=150)
print("\nArquivo gerado: real_hrv_experiment.png")
